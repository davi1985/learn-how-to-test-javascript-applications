...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    it('should return 0 whan getTotal is executed in a newly created instance', () => {
  ...
  describe('special conditions', () => {
    it('should apply percentage discount quantity abov minimum is passed', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should apply qunatity discount for even quantities', () => {
      const condition = {
        quantity: 2,
      };
    ...
    it('should NOT apply qunatity discount for even quantities when conditions is not met', () => {
      const condition = {
        quantity: 2,
      };
